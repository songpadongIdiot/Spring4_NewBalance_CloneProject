...
public class BuyProductDTO {
	...
	public String toString() {
		return "BuyProductDTO [pdCode=" + pdCode + ", pdPrice=" + pdPrice + ", pdSize=" + pdSize + ", sizeCode="
				+ sizeCode + ", pdAmount=" + pdAmount + ", pdColor=" + pdColor + ", colorCode=" + colorCode
				+ ", pdImage=" + pdImage + ", pdName=" + pdName + "]";
	}
